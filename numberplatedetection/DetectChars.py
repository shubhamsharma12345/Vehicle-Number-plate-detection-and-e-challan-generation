...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("C:/Users/HP/PycharmProjects/numberplatedetection/numberplatedetection/classifications.txt", np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt("C:/Users/HP/PycharmProjects/numberplatedetection/numberplatedetection/flattened_images.txt", np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
